...
BMachineControl_32::BMachineControl_32()
{

}

QString BMachineControl_32::getWMIHWInfo(int type)
{
    /*
...
QString BMachineControl_32::getIP()
{
    QString ip = "";
...
QString BMachineControl_32::getMac()
{
    QString strMac;
...
QString BMachineControl_32::getCPU()
{
...
QString BMachineControl_32::getInfo()
{
    QString info;
    for ( int i = 1; i != 6; ++i )
    {
...
QString BMachineControl_32::getKey(QString machineinfo, QString ddMMyyyy, int months)
{
...
bool BMachineControl_32::activeKey(QString key)
{
...
bool BMachineControl_32::initializeReg()
{
    QSettings *reg = new QSettings(kReg, QSettings::NativeFormat);
...
bool BMachineControl_32::judgeDate()
{
    QSettings *reg = new QSettings(kReg, QSettings::NativeFormat);
...
int BMachineControl_32::judgeKey()
{
    QSettings *reg = new QSettings(kReg, QSettings::NativeFormat);
...
void BMachineControl_32::refreshDT1()
{
    QSettings *reg = new QSettings(kReg, QSettings::NativeFormat);
