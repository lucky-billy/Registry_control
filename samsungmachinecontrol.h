#ifndef SAMSUNGMACHINECONTROL_H
#define SAMSUNGMACHINECONTROL_H
#include <QString>
#include <QAxObject>
#include <QDebug>
#include <QUuid>
...
class SamsungMachineControl
{
public:
    SamsungMachineControl();
    ...
    QString getKey(QString machineinfo, QString ddMMyyyy, int months, bool bindWithCP = false);

    // 注册key
    bool activeKey(QString key, bool bindWithPC = false);
...
private:
    const QString kReg = "HKEY_CURRENT_USER\\Software\\Lenovo\\Sirius_Mult_ss";
